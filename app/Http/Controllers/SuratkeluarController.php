...
class SuratkeluarController extends Controller
{
    ...
    public function update(Request $request, Suratkeluar $suratkeluar)
    {
        ...
        $suratkeluar->tgl_keluar = $request->tglmasuk;
        ...
        return redirect()->route('suratkeluar.index')->with('success','Ubah Surat Keluar sudah berhasil disimpan');
    }
